...
async function getProducts() {
    ...
    const cookie = store.get("cookie") ?? ""; // <── forward cookies
                    ...
                    {products.map((p) => (
                        ...
                        >
                            ...
                            <div className="flex gap-2 mt-2">
                                ...
                                <form
                                    action={`/api/admin/products/delete/${p.id}`}
                                    method="POST"
                                    className="flex-1"
                                >
                                    <button className="w-full text-center py-1 border border-red-500 text-red-500 rounded-md hover:bg-red-50 text-sm">
                                        Delete
                                    </button>
                                </form>
                            </div>
